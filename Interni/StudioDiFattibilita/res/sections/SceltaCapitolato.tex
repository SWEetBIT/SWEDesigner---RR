\section{Scelta del Capitolato C6}
  \subsection{Descrizione del capitolato}
    Il capitolato C6, proposto dall'azienda \emph{Zucchetti S.p.a.}, richiede lo sviluppo di una \glossaryItem{Web App} costituita da un \glossaryItem{designer} di \glossaryItem{UML} che possa utilizzare sia gli schemi tipici
