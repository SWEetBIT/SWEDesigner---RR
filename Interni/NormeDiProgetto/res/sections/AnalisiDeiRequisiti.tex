\section{Analisi dei requisiti}
  ...
  \subsection{Analisi dei requisiti}
    ...
    \subsubsection{Classificazione dei requisiti}
      ...
      \glossaryItem{Classi}ficati per tipo e per importanza utilizzando la seguente codifica:
      \begin{center}
        R[importanza][tipo][\glossaryItem{Codice}]
      \end{center}
      \begin{itemize}
        ...
        \item \textbf{Tipo} può assumere i seguenti valori:
          \bgroup
            ...
            \end{labeling}
          \egroup
        \item \textbf{Codice} è il \glossaryItem{Codice} univoco di ogni requisito espresso in modo gerarchico.
      \end{itemize}
    ...
    \subsubsection{Modellazione concettuale del sistema e Allocazione}
      ...
      \begin{itemize}
        \item \textbf{Padre: }Indicare \glossaryItem{Codice} univoco del Caso d'Uso padre;
      ...
      \begin{center}
        UC[\glossaryItem{Codice} univoco del padre].[\glossaryItem{Codice} univoco del figlio]
      \end{center}
