...
sopra citato \textit{Piano di Qualifica}.
	...
	\subsection{Sviluppo}
		\subsubsection{Analisi dei requisiti}
		 ...
		 Per semplificare il tracciamento degli \glossaryItem{Use Case} e dei Requisiti si è scelto di utilizzare \textbf{Trender}, uno strumento \glossaryItem{Open-source} che permette di gestire al meglio entrambi gli elementi e le relazioni fra gli stessi.\\
...
Scopo dell’attività di codifica è implementare in codice quanto descritto nel documento \textit{Definizione di Prodotto}. Per mantenere un alto grado di comprensione del codice sorgente, i programmatori devono seguire delle linee guida sulle tecnologie da usare, sulla nomenclatura e sulla documentazione.
   \paragraph{Convenzioni e nomenclatura del codice}
...
\paragraph{Tecnologie e infrastruttura}
...
\end{itemize}
Per la stesura del codice ogni \textit{Programmatore} deve scrivere codice usando \glossaryItem{Microsoft Visual Studio} \url{https://www.visualstudio.com/it/} ed è tenuto ad accettare la formattazione automatica del codice.\\
