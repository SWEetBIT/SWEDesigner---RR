...
\paragraph{Telegram}   
	Il servizio di messaggistica istantanea \glossaryItem{Telegram}, è stato utilizzato per il coordinamento delle riunioni e per l'inoltro di informazioni d'interesse per tutti i membri del gruppo.
