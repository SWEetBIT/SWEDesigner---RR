...
\subsection{Coordinamento}
	...
	Nascono dal \emph{Piano di Progetto}, il cambiamento è già controllato, e quindi basta registrallo aggiornando la versione dell'elemento che è stato cambiato.
...
\begin{itemize}
\item \textbf{JSHint: }uno strumento che aiuta ad identificare gli errori e i potenziali problemi nel codice JavaScript;
\item \textbf{JSLint: }uno strumento usato per verificare che il codice JavaSript compila secondo le regole del linguaggio;
...
\begin{itemize}
\item \textbf{Mocha: } una libreria ricca di funzionalità per l'esecuzione di test JavScript
\end{itemize}
