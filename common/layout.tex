...
% permette al comando \url{...} di andare a capo a met� di un link
\usepackage{breakurl}
...
% per avere dei comandi in pi� da poter usare sulle tabelle
\usepackage{booktabs}
...
% su Ubuntu non si pu� installare il pacchetto, deve essere in modello/
...
% personalizza l'intestazione e pi� di pagina
\usepackage{fancyhdr}
...
\fancypagestyle{plain}{
	% cancella tutti i campi di intestazione e pi� di pagina
	\fancyhf{}

	\lhead{
		\includegraphics[height=1cm, keepaspectratio=true]{../../common/logo.jpg}
		\parbox[b]{10cm}{
			\emph{\GroupName{}} - Progetto \ProjectName{} \vspace{0pt} \\
...
\lstset{
  ...
  inputencoding=utf8,   % converte i caratteri utf8 in latin1, richiede \usepackage{listingsutf8} anzich� listings
...
%per file in output trender
\usepackage{../../common/command}
\usepackage{../../common/config}
