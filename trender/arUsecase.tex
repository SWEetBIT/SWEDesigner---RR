...
\item \textbf{Precondizione}: L'applicazione predispone la possibilita di registrazione;
...
\item \textbf{Precondizione}: L'applicazione e pronta e l'attore intende autenticarsi;
...
\item \textbf{Precondizione}: L’applicazione mette a disposizione dell’attore la possibilita di logout;
