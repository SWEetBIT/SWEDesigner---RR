...
\[UC[\glossaryItem{Codice} del padre].[\glossaryItem{Codice} progressivo di livello]\]
Il \glossaryItem{Codice} progressivo puoò includere diversi livelli di gerarchia separati da un punto.
...
\begin{itemize} 
\item \textbf{Attori}: \glossaryItem{Utente} non autenticato;
\item \textbf{Descrizione}: L’attore inserisce l'\glossaryItem{Username}: deve essere univoco all'interno dell'\glossaryItem{Applicazione} e deve essere alfanumerico;
...
\begin{itemize} 
\item \textbf{Attori}: \glossaryItem{Utente} non autenticato;
\item \textbf{Descrizione}: L'attore può inserire un \glossaryItem{Username} non conforme e gli viene quindi comunicato l'errore;
...
\item \textbf{Scenario principale}: 
	\begin{enumerate}\item Modifica \glossaryItem{Username} (UC3.1);\item Modifica Password (UC3.2);\item Modifica Email (UC3.3);\item Eliminazione Profilo (UC3.4);\end{enumerate}
\item \textbf{Scenario alternativo}: 
	\begin{enumerate} \item Messaggio di errore: "\glossaryItem{Username} non conforme" (UC3.5);\item Messaggio di errore: "Password non conforme" (UC3.6);\item Messaggio di errore: "Email non conforme" (UC3.7). 
	\end{enumerate}
\end{itemize} 
...
\begin{itemize} 
\item \textbf{Attori}: \glossaryItem{Utente} autenticato;
\item \textbf{Descrizione}: L'attore può modificare il suo \glossaryItem{Username};
\item \textbf{Precondizione}: L'attore vuole modificare l'\glossaryItem{Username};
\item \textbf{Postcondizione}: L'\glossaryItem{Applicazione} modifica l' \glossaryItem{Username} dell'attore;
\item \textbf{Scenari alternativi}: L'attore annulla la modifica dell'\glossaryItem{Username}.
\end{itemize} 
...
\end{itemize} 
\subsection{UC3.5 - Messaggio di errore: "\glossaryItem{Username} non conforme"} 
\label{ssec:UC3.5} 
\begin{itemize} 
\item \textbf{Attori}: \glossaryItem{Utente} autenticato;
\item \textbf{Descrizione}: L'attore può inserire un \glossaryItem{Username} non conforme e gli viene quindi comunicato l'errore;
\item \textbf{Precondizione}: L'\glossaryItem{Applicazione} è pronta e l'attore modifica l'\glossaryItem{Username};
\item \textbf{Postcondizione}: L'attore ha inserito un \glossaryItem{Username} non conforme e ha ricevuto la comunicazione dell'errore.
\end{itemize} 
...
\begin{itemize} 
\item \textbf{Attori}: \glossaryItem{Utente} autenticato;
\item \textbf{Descrizione}: L’ attore può accedere alle voci \glossaryItem{File}, edit, tool,
\glossaryItem{Layer}s appartenenti al menù del Tool \glossaryItem{Designer};
...
\item \textbf{Scenario principale}: \begin{enumerate}\item \glossaryItem{File} (UC6.1.1);\item Edit (UC6.1.2);\item \glossaryItem{Template} (UC6.1.3);\item \glossaryItem{Layer}s (UC6.1.4). 
 \end{enumerate}
\end{itemize} 
\newpage
...
\begin{itemize} 
\item \textbf{Attori}: \glossaryItem{Utente} autenticato;
\item \textbf{Descrizione}: L’attore può accedere alle voci salva, chiudi, esporta, genera \glossaryItem{Codice} e salva \glossaryItem{Template} appartenenti alla voce \glossaryItem{File} del menù;
\item \textbf{Precondizione}: L’\glossaryItem{Applicazione} offre all’attore la voce \glossaryItem{File} nella barra dei menù;
\item \textbf{Postcondizione}: L’\glossaryItem{Applicazione}, a seconda dell’operazione richiesta dall’\glossaryItem{Utente},
svolge le sue funzioni;
...
\item \textbf{Precondizione}: L’attore vuole generare il \glossaryItem{Codice} dai suoi \glossaryItem{Diagrammi} \glossaryItem{UML};
...
\item \textbf{Precondizione}: L’\glossaryItem{Applicazione} offre all’attore la voce salva \glossaryItem{Template}, sottovoce di \glossaryItem{File} nel menù, solamente se sono state create una o più \glossaryItem{Classi}, ed ognuna di esse ha un commento che le identifica;
...
\end{itemize} 
\newpage
\subsection{UC6.1.4 - \glossaryItem{Layer}s} 
\label{ssec:UC6.1.4} 
\begin{figure}[h!] 
\centering 
...
\begin{itemize} 
\item \textbf{Attori}: \glossaryItem{Utente} autenticato;
\item \textbf{Descrizione}: L’attore  può accedere alla visualizzazione della lista dei \glossaryItem{Layer}s. Può inoltre creare nuovi \glossaryItem{Layer} oppure rinominarne o eliminarne di già esistenti;
\item \textbf{Precondizione}: L’attore ha un progetto aperto;
...
\begin{itemize} 
\item \textbf{Attori}: \glossaryItem{Utente} autenticato;
\item \textbf{Descrizione}: L'attore, per la creazione di un \glossaryItem{Diagramma} della \glossaryItem{Classi} ha la possibilità di selezionare una nuova \glossaryItem{Classe}, inserire un \glossaryItem{Package} per raggruppare delle \glossaryItem{Classi} o inserire delle relazioni tra le \glossaryItem{Classi};
\item \textbf{Precondizione}: L'attore ha aperto un progetto;
