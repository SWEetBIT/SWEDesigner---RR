...
\begin{itemize} 
\item \textbf{Attori}: .
\item \textbf{Descrizione}: L'utente può inserire nella finestra del disegnatore dei diagrammi (UC 6.3) il template selezionato;
...
\begin{itemize} 
\item \textbf{Attori}: .
\item \textbf{Descrizione}: L'utente può eliminare dalla lista il template selezionato;
...
\end{itemize} 
\subsubsection{UC6.3.1.1.3 - Eliminazione Metodo} 
