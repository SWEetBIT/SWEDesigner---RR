...
\item \textbf{Scenario principale}: \begin{enumerate}\item Registrazione (UC1);\item Autenticazione (UC2);\item Gestione profilo(UC3);\item Logout (UC4);\item Gestione progetti (UC5);\item Visione generale Tool \glossaryItem{Designer} (UC6); \item Password dimenticata.
 \end{enumerate}
...
\item \textbf{Scenario principale}: \begin{enumerate}\item Inserimento \glossaryItem{Username}/Email (UC2.1);\item Inserimento Password (UC2.2).  \end{enumerate}

\item \textbf{Scenari alternativi}: \begin{enumerate}
\item Credenziali errate (UC2.3). \end{enumerate}
...
\item \textbf{Scenario principale}: L'attore inserisce la password.
\end{itemize}
\subsection{UC2.3 - Credenziali errate}
\label{ssec:UC2.3}
\begin{itemize}
\item \textbf{Attori}: \glossaryItem{Utente} non autenticato;
...
\end{itemize}
\newpage
\subsection{UC6 - Visione generale Tool \glossaryItem{Designer}}
\label{ssec:UC6}
\begin{figure}[h!]
\centering
...
\item \textbf{Scenario principale}: \begin{enumerate}\item Utilizzo strumenti per la gestione di file ed editor (UC6.1);\item Utilizzo strumenti grafici per classi e metodi (UC6.2);\item Implementazione \glossaryItem{diagrammi} di classi e metodi (UC6.3);\item Consultazione flusso del programma (UC6.4).
 \end{enumerate}
\end{itemize}
\newpage
\subsection{UC6.1 - Utilizzo strumenti per la gestione di file ed editor}
\label{ssec:UC6.1}
\begin{figure}[h!]
\centering
...
\glossaryItem{layers} appartenenti al menù del Tool \glossaryItem{Designer};
...
\item \textbf{Scenario principale}: \begin{enumerate}\item Gestione File (UC6.1.1);\item Gestione stumenti di modifica (UC6.1.2);\item Gestione \glossaryItem{Template} (UC6.1.3);\item Gestione \glossaryItem{layers} (UC6.1.4).
 \end{enumerate}
\end{itemize}
\newpage
\subsection{UC6.1.1 - Gestione File}
\label{ssec:UC6.1.1}
\begin{figure}[h!]
\centering
...
\item \textbf{Precondizione}: L'attore ha aperto un progetto;
\item \textbf{Postcondizione}: L’\glossaryItem{Applicazione} visualizza la lista delle funzionalità disponibili;
\item \textbf{Scenario principale}: \begin{enumerate}\item Annullare operazione sull'editor (UC6.1.2.1);\item Ripristinare operazione sull'editor (UC6.1.2.2);\item Eliminare elemento dal diagramma (UC6.1.2.3);\item Copiare elemento sul diagramma (UC6.1.2.4);\item Inserire elemento sul diagramma (UC6.1.2.5);\item Ingrandire visualizzazione diagrammi (UC6.1.2.6);\item Ridurre visualizzazione diagrammi (UC6.1.2.7).
 \end{enumerate}
\end{itemize}
\subsection{UC6.1.2.1 - Annullare operazione sull'editor}
...
\end{itemize}
\subsection{UC6.1.2.2 - Ripristinare operazione sull'editor}
...
\end{itemize}
\subsection{UC6.1.2.3 - Eliminare elemento dal \glossaryItem{diagramma}}
...
\end{itemize}
\subsection{UC6.1.2.4 - Copiare elemento sul \glossaryItem{diagramma}}
...
\end{itemize}
\subsection{UC6.1.2.5 - Inserire elemento sul \glossaryItem{diagramma}}
...
\end{itemize}
\subsection{UC6.1.2.6 - Ingrandire visualizzazione \glossaryItem{diagrammi}}
...
\end{itemize}
\subsection{UC6.1.2.7 - Ridurre visualizzazione \glossaryItem{diagrammi}}
...
\end{itemize}
\newpage
\subsection{UC6.1.4 - Gestione \glossaryItem{Layers}}
\label{ssec:UC6.1.4}
\begin{figure}[h!]
\centering
...
\begin{itemize}
\item \textbf{Attori}: \glossaryItem{Utente} autenticato;
\item \textbf{Descrizione}: L’attore  può accedere alla visualizzazione della lista dei \glossaryItem{layers}. Può inoltre creare nuovi \glossaryItem{layer} oppure rinominarne o eliminarne di già esistenti;
\item \textbf{Precondizione}: L’attore ha un progetto aperto;
\item \textbf{Postcondizione}: L'\glossaryItem{Applicazione} visualizza la lista delle funzionalità disponibili sui \glossaryItem{layer};
\item \textbf{Scenario principale}: \begin{enumerate}\item Nuovo \glossaryItem{layer} (UC6.1.4.1);\item Lista \glossaryItem{layer} (UC6.1.4.2);\item Modifica \glossaryItem{layer} (UC6.1.4.3).
 \end{enumerate}
\end{itemize}
\subsection{UC6.1.4.1 - Nuovo \glossaryItem{layer}}
\label{ssec:UC6.1.4.1}
\begin{itemize}
\item \textbf{Attori}: \glossaryItem{Utente} autenticato;
\item \textbf{Descrizione}: L'attore crea un nuovo \glossaryItem{layer} a cui è possibile assegnare delle \glossaryItem{Classi};
\item \textbf{Precondizione}: L'attore ha aperto la finestra di gestione dei \glossaryItem{layer};
\item \textbf{Postcondizione}: L'attore ha aggiunto un nuovo \glossaryItem{layer} assegnandogli il nome desiderato;
\item \textbf{Scenario principale}: L'attore crea un nuovo \glossaryItem{layer}.
\end{itemize}
\subsection{UC6.1.4.2 - Lista \glossaryItem{layer}}
\label{ssec:UC6.1.4.2}
\begin{itemize}
\item \textbf{Attori}: \glossaryItem{Utente} autenticato;
\item \textbf{Descrizione}: L'attore seleziona il \glossaryItem{layer} di cui desidera visualizzare le \glossaryItem{Classi} che gli sono state assegnate;
\item \textbf{Precondizione}: L'attore ha aperto la finestra di gestione dei \glossaryItem{layer};
\item \textbf{Postcondizione}: L'attore ha visualizzato le \glossaryItem{Classi} assegnate al \glossaryItem{layer} desiderato;
\item \textbf{Scenario principale}: L'attore seleziona il \glossaryItem{layer} desiderato dalla lista.
\end{itemize}
\newpage
\subsection{UC6.1.4.3 - Modifica \glossaryItem{layer}}
...
\begin{itemize}
\item \textbf{Attori}: \glossaryItem{Utente} autenticato;
\item \textbf{Descrizione}: L'attore desidera rinominare oppure eliminare un \glossaryItem{layer} tra quelli esistenti;
\item \textbf{Precondizione}: L'attore ha aperto la finestra di gestione dei \glossaryItem{layer};
\item \textbf{Postcondizione}: L'\glossaryItem{Applicazione} apre la finestra di gestione dei \glossaryItem{layer};
\item \textbf{Scenario principale}: \begin{enumerate}\item Rinominazione \glossaryItem{layer} (UC6.1.4.3.1);\item Eliminazione \glossaryItem{layer} (UC6.1.4.3.2).
 \end{enumerate}
\end{itemize}
\subsection{UC6.1.4.3.1 - Rinominazione \glossaryItem{layer}}
\label{ssec:UC6.1.4.3.1}
\begin{itemize}
\item \textbf{Attori}: \glossaryItem{Utente} autenticato;
\item \textbf{Descrizione}: L'attore desidera rinominare un \glossaryItem{layer} tra quelli esistenti;
\item \textbf{Precondizione}: L'attore seleziona il \glossaryItem{layer} da rinominare;
\item \textbf{Postcondizione}: L'attore ha modificato il nome del \glossaryItem{layer} che intendeva modificare, mantenendo tutte le \glossaryItem{Classi} associate;
\item \textbf{Scenario principale}: L'attore rinomina un \glossaryItem{layer} esistente.
\end{itemize}
\subsection{UC6.1.4.3.2 - Eliminazione \glossaryItem{layer}}
\label{ssec:UC6.1.4.3.2}
\begin{itemize}
\item \textbf{Attori}: \glossaryItem{Utente} autenticato;
\item \textbf{Descrizione}: L'attore desidera eliminare un \glossaryItem{layer} tra quelli esistenti;
\item \textbf{Precondizione}: L'attore seleziona un \glossaryItem{layer};
\item \textbf{Postcondizione}: L'\glossaryItem{Applicazione} ha eliminato il \glossaryItem{layer} che intendeva modificare e tutte le \glossaryItem{Classi} assegnate a tale \glossaryItem{layer}, se ce n'erano, non risultano più assegnate a nessun \glossaryItem{layer};
\item \textbf{Scenario principale}: L'attore elimina un \glossaryItem{layer} esistente.
\end{itemize}
\newpage
\subsection{UC6.2 - Utilizzo strumenti grafici per classi e metodi }
\label{ssec:UC6.2}
\begin{figure}[h!]
\centering
...
\item \textbf{Scenario principale}: \begin{enumerate}\item Gestione strumenti strumenti \glossaryItem{Diagramma delle Classi} (UC6.2.1);\item Gestione strumenti \glossaryItem{Diagramma delle Attività} (UC6.2.2).
 \end{enumerate}
\end{itemize}
\newpage
\subsection{UC6.2.1 - Gestione strumenti strumenti \glossaryItem{Diagramma delle Classi}}
\label{ssec:UC6.2.1}
\begin{figure}[h!]
\centering
...
\end{itemize}
\subsection{UC6.2.2 - Gestione strumenti \glossaryItem{Diagramma delle Attività}}
\label{ssec:UC6.2.2}
\begin{figure}[H]
\centering
...
\item \textbf{Scenario principale}: \begin{enumerate}\item Nuova operazione (UC6.2.2.1);\item Nuova chiamata a \glossaryItem{Metodo} (UC6.2.2.2);\item Nuova variabile (UC6.2.2.3);\item Nuovo connettore (UC6.2.2.4);\item Nuovo nodo decisione (UC6.2.2.5);\item Nuovo nodo \glossaryItem{Merge} (UC6.2.2.6);\item Nuovo commento (UC6.2.2.7);\item Nuovo output pin (UC6.2.2.8).
 ...
 \item Modifica chiamata a \glossaryItem{Metodo} (UC 6.3.5.11);
...
\end{itemize}
\newpage
\subsection{UC6.3 - Implementazione diagrammi di metodi e classi}
\label{ssec:UC6.3}
\begin{figure}[h!]
\centering
...
\item \textbf{Postcondizione}: Viene eliminata la \glossaryItem{Classe} selezionata, la quale richiama l'eliminazione di:
\begin{itemize}
\item tutti i \glossaryItem{Metodi} che le appartengono (UC 6.3.1.10);
\item tutti gli attributi associati(UC 6.3.1.11);
\item tutte le relazioni(UC 6.3.1.2) che la coinvolgono.
\end{itemize} 
\item \textbf{Scenario principale}: \begin{enumerate}\item Eliminazione \glossaryItem{Metodo} (UC 6.3.1.10);\item Eliminazione Attributo (UC 6.3.1.11);\item Eliminazione Relazioni (UC 6.3.1.2).
 \end{enumerate}
\end{itemize}
...
\end{itemize}
\subsection{UC6.3.1.5.8 - Modifica assegnazione \glossaryItem{layer}}
\label{ssec:UC6.3.1.5.8}
\begin{itemize}
\item \textbf{Attori}: \glossaryItem{Utente} autenticato;
\item \textbf{Descrizione}: L'attore può selezionare il \glossaryItem{layer} a cui vuole associare la \glossaryItem{Classe};
\item \textbf{Precondizione}: Viene visualizzato un form che permette l'assegnazione del \glossaryItem{layer};
\item \textbf{Postcondizione}: L'\glossaryItem{Applicazione} registra il dato inserito;
\item \textbf{Scenario principale}: L'attore modifica l'assegnazione ad un \glossaryItem{layer} di una classe.
\end{itemize}
...
\end{itemize}
\subsection{UC6.3.1.10 - Eliminazione Metodo}
\label{ssec:UC6.3.1.10}
\begin{itemize}
\item \textbf{Attori}: \glossaryItem{Utente} autenticato;
...
\end{itemize}
\subsection{UC6.3.1.11 - Eliminazione Attributo}
\label{ssec:UC6.3.1.11}
\begin{itemize}
\item \textbf{Attori}: \glossaryItem{Utente} autenticato;
...
\end{itemize};
\newpage
\subsection{UC6.4 - Consultazione flusso del programma}
\label{ssec:UC6.4}
...
\end{itemize}
\newpage
\subsection{UC7 - Password dimenticata}
\label{ssec:UC7}
\begin{figure}[h!]
\centering
\includegraphics[scale=0.5]{../../Casi D'uso/UC7.png}
\caption{Caso d'uso UC7}
 \end{figure}
\begin{itemize}
\item \textbf{Attori}: \glossaryItem{Utente} non autenticato;
...
\end{itemize}
\subsection{UC7.1 - Invio password per email}
\label{ssec:UC7.1}
\begin{itemize}
\item \textbf{Attori}: \glossaryItem{Utente} non autenticato;
