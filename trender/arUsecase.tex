...
\item \textbf{Scenario principale}: \begin{enumerate}\item File (UC6.1.1);\item Edit (UC6.1.2);\item \glossaryItem{Template} (UC6.1.3);\item \glossaryItem{layers} (UC6.1.4).
 \end{enumerate}
\end{itemize}
\newpage
...
\end{itemize}
\newpage
\subsection{UC6.1.4 - \glossaryItem{layers}}
\label{ssec:UC6.1.4}
\begin{figure}[h!]
\centering
