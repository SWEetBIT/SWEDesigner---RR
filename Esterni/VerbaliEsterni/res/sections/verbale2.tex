	\section{Riunione 2}
	  ...
	  \subsection{Domande e Risposte}
	   \begin{itemize}
	   	...
	   	%RISPOSTA
	    	\justifying     		
L'idea di sfruttare questi \glossaryItem{diagrammi} è apprezzata, così come la possibilità di scegliere quale dei due \glossaryItem{diagrammi} mettere in primo piano.\\
	   	\item 
	   	%dDOMANDA
