\section{Strategia di verifica nel dettaglio}
  ...
  \end{itemize}
    ...
    \begin{de\glossaryItem{Script}ion}
      ...
      \begin{itemize}
        ...
        \item Range di ottimalità = [\(\geq\)0].
      \end{itemize}
    \end{de\glossaryItem{Script}ion}
    ...
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item Range di ottimalità = [1].
      \end{itemize}
      La \textbf{metrica esterna} utilizata è l'\textbf{Efficacia della documentazione}, la quale serve a misurare l'efficacia con la quale la documentazione viene compresa dall'\glossaryItem{Utente},
  ...
  \subsection{Tecniche di analisi}
    ...
    \begin{itemize}
      \item \textbf{Test di unità}: l'obiettivo di questo test è quello di riuscire a capire se ogni unità del \glossaryItem{Codice} si comporti esattamente come previst. Un unità di \glossaryItem{Codice} è la più piccola parte di software testabile;
