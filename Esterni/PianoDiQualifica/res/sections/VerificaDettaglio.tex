\section{Strategia di verifica nel dettaglio}
  ...
  \end{itemize}
    ...
    Come descritto nello standard \glossaryItem{ISO}/\glossaryItem{IEC} 9126, si posso identificare due tipi di metriche utilizzate per misurare la qualità del prodotto software, esse sono:
    \begin{itemize}
    ...
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item Range di ottimalità = [1].
      \end{itemize}
      La \textbf{metrica esterna} utilizzata è l'\textbf{Efficacia della documentazione}, la quale serve a misurare l'efficacia con la quale la documentazione viene compresa dall'\glossaryItem{Utente},
      ...
      \begin{itemize}
        ...
        \item FAppr = numero di funzioni apprese e completate con successo dall'\glossaryItem{Utente} accedendo alla documentazione;
        \item Fnd = numero di volte in cui l'\glossaryItem{Utente} ha dovuto accedere alla documentazione, per capire il funzionamento di una funzione, durante i test.
      \end{itemize}
      I range stabiliti sono:
      \begin{itemize}
        \item Range di accettabilità = [0.7-1];
      ...
      il quale indica il tempo medio di risposta del sistema ad un comando immesso dall'\glossaryItem{Utente}.
      \begin{center}
      ...
      \item \textbf{Manutenibilità}\\
        ...
        \begin{itemize}
          \item \textbf{Complessità ciclomatica}: è una metrica per la misura della complessità del \glossaryItem{Codice}; la quale è calcolata mediate il grafo di controllo di flusso relativo al \glossaryItem{Codice}.
            I nodi del grafo sono gruppi di istruzioni indivisibili. Se nel \glossaryItem{Codice} non sono presenti punti decisionali o cicli, allora la complessità ciclomatica sarà pari a 1. La formula per il caclolo della complessità ciclomatica è:
            \begin{center}
              \emph{Cc = a - n + 2p}
            \end{center}
            Dove:
            ...
            \end{itemize}
          \item \textbf{Complessità delle classi}: serve a misurare il livello di complessità di una \glossaryItem{Classe}, si basa sul conteteggio dei campi dati presenti in essa.
          Se una \glossaryItem{Classe} presenta troppi campi dati è probabile che essa possa essere divisa in più \glossaryItem{Classi}.
            \begin{center}
              \emph{Complessità \glossaryItem{Classe} = numero campi dati}
            \end{center}
            I range stabiliti sono:
            \begin{itemize}
        ...
        la quale ha lo scopo è di riuscire a misurare la facilità di manutenzione del \glossaryItem{Codice} senza che si generino ulteriori errori.
        La formula è la seguente:
        \begin{center}
  ...
  \subsection{Tecniche di analisi}
    ...
    Questa tecnica permette di verificare sia la documentazione che il \glossaryItem{Codice}.
    ...
    \begin{itemize}
      \item \textbf{Test di unità}: l'obiettivo di questo test è quello di riuscire a capire se ogni unità del \glossaryItem{Codice} si comporti esattamente come previsto. Un unità di \glossaryItem{Codice} è la più piccola parte di software testabile;
