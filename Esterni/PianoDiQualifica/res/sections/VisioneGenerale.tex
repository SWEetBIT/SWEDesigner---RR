\section{Visione generale delle strategie di verifica}
  ...
  che quelli relativi ai processi necessari alla sua produzione.
    ...
    \begin{itemize}
      \item \textbf{Funzionalità}: il prodotto deve soddisfare i requisiti indicati nel documento \Versione{AR};
  ...
  \subsection{Organizzazione}
    Per onguno dei periodi descritto dal \Versione{PP} è necessario seguire una verifica mirata al tipo di processo e relativo prodotto:
    \begin{itemize}
      \item \textbf{Analisi:} in questo periodo vengono controllati i processi e la documentazione prodotta.
      La verifica dovà essere eseguita secondo i \glossaryItem{Metodi} descritti nel documento \Versione{Norme di Progetto};
      ...
      Le procedure di verifica sono descritte nel documento \Versione{NP};
      ...
      Le procedure di verifica sono descritte in dettaglio nel documento \Versione{NP};
      ...
      Vengono verificati processi e prodotti della sotto-fase di codifica. Le procedure di verifica sono descritte nel documento \Versione{NP}.
  ...
  \subsection{Pianificazione strategica e temporale}
    Intendendo rispettare le scadenze specificate nel \Versione{PP}, è necessario un approccio organico e ben pianificato alle attività di verifica.
    ...
    risparmiare su risorse umane. L'utilizzo di software apposito, e dei \glossaryItem{Metodi} per la verifica, sono descritti nel documento \emph{Norme di Progetto}.
  ...
  \subsection{Gestione delle responsabilità}
    ...
    I compiti di queste figure sono argomento trattato nel documento \Versione{PP}.
  ...
  \subsection{Risorse}
    ...
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item Verificatore.
      \end{itemize}
      Ognuno dei sopracitati ruoli è descritto nel dettaglio nel documento \Versione{PP};
      ...
      sia l'hardware neccessario per eseguire il suddetto software. Nel documento \Versione{NP} sono descritti nel dettaglio
