\section{Introduzione}
  ...
  \subsection{Glossario}
          ...
          gruppo ha steso un documento interno che è il \Versione{G}. In esso saranno definiti, in modo
          chiaro e conciso, i termini che possono causare ambiguità o incomprensione del testo.
  \subsection{Riferimenti}
    \subsubsection{Informativi}
      \begin{itemize}
        \item \textbf{Analisi dei requisiti:} \Versione{AR}
        \item \textbf{Piano di progetto:} \Versione{PP}
    ...
    \subsubsection{Normativi}
      \begin{itemize}
        \item \textbf{Norme di progetto:} \Versione{NP}
