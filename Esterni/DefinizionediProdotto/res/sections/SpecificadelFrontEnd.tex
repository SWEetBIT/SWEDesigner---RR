				...
				\begin{itemize}
          			...
          			\begin{itemize}
          				...
          				\item \textbf{Parametri:}\\
            				...
            				\end{itemize}
          				\item \emph{+this.paper.on('cell:pointerdown', (cellView) =>: void}\\
          				Questo metodo riconosce quando una classe viene cliccata e quindi la seleziona
          				\item \textbf{Parametri:}\\
            				\begin{itemize}
            					\item \emph{cellView: any}\\
            					Elemento cliccato
            				\end{itemize}
          				\item \emph{+this.paper.on('blank:pointerdown', () =>: void}\\
          				Questo metodo riconosce quanto la classe viene deselezionata cliccando al di fuori di essa
          				\item \emph{+this.paper.on('cell:pointerdown', (cellView) =>: void}\\
