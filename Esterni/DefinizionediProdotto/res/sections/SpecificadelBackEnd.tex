\section{Specifica Back-End}
  ...
  \subsection{SWEDesigner::Server::Controller::Middleware}
    \subsubsection{Informazioni generali}
      ...
      \end{itemize}
    \subsubsection{Classi}
      \subsubsubsection{SWEDesigner::Server::Controller::Middleware::midLoader}
        \begin{itemize}
          \item \textbf{Descrizione: }\\
          ...
          \end{itemize}
        \end{itemize}
      \subsubsubsection{SWEDesigner::Server::Controller::Middleware::Parse}
        \begin{itemize}
          \item \textbf{Descrizione: }\\
          ...
          \end{itemize}
        \end{itemize}
      \subsubsubsection{SWEDesigner::Server::Controller:Middleware::Encrypt}
        \begin{itemize}
          \item \textbf{Descrizione: }\\
  ...
  \subsection{SWEDesigner::Server::Controller::Services}
    \subsubsection{Informazioni generali}
      ...
      \end{itemize}
    \subsubsection{Classi}
      \subsubsubsection{SWEDesigner::Server::Controller::Services::parseService}
        \begin{itemize}
          \item \textbf{Descrizione:}\\
          ...
          \end{itemize}
        \end{itemize}
      \subsubsubsection{SWEDesigner::Server::Controller::Services::encryptService}
        \begin{itemize}
          \item \textbf{Descrizione: }\\
