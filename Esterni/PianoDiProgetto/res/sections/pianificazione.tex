\section{Pianificazione}
	...
	\begin{itemize}
		...
		\item \textbf{Lettera di presentazione:} Viene redatta una lettera da presentare al \glossaryItem{Committente} per permettere al gruppo di partecipare alla gara d'appalto per il \glossaryItem{Capitolato}. \\
	\end{itemize}
	...
	\textbf{Periodo:} da 2017-04-10 a 2017-04-22 \\
	Questo periodo inizia qualche giorno prima della \textbf{Revisione dei Requisiti} e si conclude con l'inizio del periodo di \textbf{Progettazione Architetturale}. \\
	...
	\textbf{Periodo:} da 2017-04-23 a 2017-05-8 \\
...
della \textit{Revisione dei Requisiti}. \\
	...
	\begin{itemize}
		...
		\item \textbf{Codifica:} Si procede allo sviluppo del \glossaryItem{Codice} del software da parte dei programmatori, seguendo quanto è riportato nella \textit{Definizione di Prodotto};
