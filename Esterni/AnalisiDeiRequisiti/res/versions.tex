...
\begin{center}
    ...
    \begin{longtable}{ >{\centering}p{1.8cm} | >{\centering}p{2.2cm} | >{\centering}p{3cm} | >{\centering}p{6cm} }
      \textbf{Versione} & \textbf{Data} & \textbf{Persone coinvolte} & \textbf{Descrizione} \tabularnewline \hline
		...
		2.0.0 & 2017/04/25 & Boh & Approvazione Documento \tabularnewline \hline %	
		
		1.3.0 & 2017/04/24 & Boh & Verifica Documento \tabularnewline \hline %		
		
		1.2.7 & 2017/04/23 & Boh & Glossarizzazione elementi mancanti \tabularnewline \hline %		
		
		1.2.6 & 2017/04/23 & Boh & Modifica tabelle tracciamento requisiti \tabularnewline \hline %		
		
		1.2.5 & 2017/04/21 & Boh & 	Correzione gerarchia UC2 \tabularnewline \hline %
		
		1.2.4 & 2017/04/20 & Santimaria Davide  & Spostati i sotto-casi d'uso UC 6.3.1.1.1 e UC 6.3.1.1.2 nel UC 6.3.1, ed aggiunte le opportune inclusioni \tabularnewline \hline %
		...
		1.2.1 & 2017/04/19 & Santimaria Davide  & Estesa la sezione 3.2 Funzione di prodotto \tabularnewline \hline %
